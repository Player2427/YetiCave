...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo" href="index.php?page=index">
            <img src="../img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
        </a>
        <form class="main-header__search" method="get" action="inc/form-search.php" autocomplete="off">
            <input type="search" name="search" placeholder="Поиск лота">
            <input class="main-header__search-btn" type="submit" name="find" value="Найти">
        </form>
        <a class="main-header__add-lot button" href="index.php?page=add-lot">Добавить лот</a>

        <nav class="user-menu">
            <?php if ($is_auth): ?>
                <div class="user-menu__logged">
                    <p><?=$user_name?></p>
                    <a class="user-menu__bets" href="index.php?page=my-bets">Мои ставки</a>
                    <a class="user-menu__logout" href="index.php?page=logout">Выход</a>
                </div>
            <?php else: ?>
                <ul class="user-menu__list">
                    <li class="user-menu__item">
                        <a href="index.php?page=sign-up">Регистрация</a>
                    </li>
                    <li class="user-menu__item">
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="index.php?page=add-lot">Добавить лот</a>
        <div class="main-footer__developed-by">
            <span class="visually-hidden">Разработано:</span>
            <a class="logo-academy" target="_blank" href="https://htmlacademy.ru/intensive/php">
